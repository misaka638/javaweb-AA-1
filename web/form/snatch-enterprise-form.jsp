...
<div class="main">
    ...
    <div class="bd">
        <div class="bd-tl">
            <h5>抢班管理 > 企业抢班 > 详情</h5>
            <button onclick="window.location.href='snatch-enterprise.jsp'">返回</button>
        </div>
        <div class="details">
            <div class="row">
            ...
            <div class="row">
                ...
                <div class="row-bd">
                    <div class="row-m">
                        ...
                        <div class="item">岗位： 导购</div>
                    </div>
                    <div class="row-m">
                        <div class="item">奖励工时： 120%</div>
                        <div class="item">空缺人数： 1</div>
                        <div class="item"></div>
                        <div class="item"></div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="row-tl">请假人信息</div>
                <div class="row-bd">
                    <div class="row-m">
                        <div class="item">姓名： 王新宇</div>
                        <div class="item">工号：20221215063</div>
                        <div class="item">门店： 杭州市余杭区快步001店</div>
                        <div class="item">岗位： 导购</div>
                    </div>
                    <div class="row-m">
                        <div class="item">电话： 13524691566</div>
                        <div class="item">本月请假次数： 1</div>
                        <div class="item">请假时间：2022-12-19 09:00  --  2022-12-19 22:00</div>
                        <div class="item"></div>
                    </div>
                    <div class="row-m">
                        <div class="item">请假原因： 生病，需要请假去医院看病。</div>
                        <div class="item"></div>
                        <div class="item"></div>
                        <div class="item"></div>
                    </div>
            ...
            <div class="row">
                ...
                <div class="row-bd">
                    <div class="row-m">
                        <div class="item">姓名： 王芳</div>
                        <div class="item">工号：20221215033</div>
                        <div class="item">门店： 杭州市余杭区快步001店</div>
                        <div class="item">岗位： 导购</div>
                    </div>
                    <div class="row-m">
                        <div class="item">电话： 18945157682</div>
            ...
            <div class="btn">
                <button onclick="window.location.href='snatch-enterprise.jsp'">取消</button>
                <button onclick="window.location.href='snatch-enterprise.jsp'">确认</button>
            </div>
        </div>
    </div>
</div>
